    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 px-4">
        <div className="w-full max-w-md bg-white rounded-xl shadow-sm border border-gray-200 p-8 text-center">
          ...
          <Button variant="outline" onClick={() => setConfirmationSent(false)} className="w-full">
            Back to sign up
          </Button>
        </div>
      </div>
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mt-4">Start for free</h1>
          <p className="text-gray-500 mt-1">Turn your financial data into board-ready reports</p>
        </div>
